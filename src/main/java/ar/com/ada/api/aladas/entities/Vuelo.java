...
public class Vuelo {
    ...
    public enum EstadoVueloEnum{
              GENERADO(1), ORIGEN_ASIGNADO(2), DESTINO_ASIGNADO(3), TRIPULACION_PREASIGNADA(4), ABIERTO(5), CONFIRMADO(6), REPROGRAMADO(7), CANCELADO(8), CERRADO(9);
         //ABIERTO = Estado de vuelo que todavia acepta pasajeros
         //No agregamos mas estados porque este sistema esta apuntado al sistema de reservas y no al de trafico aereo
